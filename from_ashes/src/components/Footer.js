                    ...
                    <div className="row">
                        <div className="col-4 d-none d-sm-block col-sm-2 offset-1">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li><a href="className_resources.html">ClassName Resources</a></li>
                            </ul>
                        </div>
                        <div className="col-12 col-sm-5 text-center">
                            ...
                            <a className="btn btn-social-icon twitch" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" fill="currentColor" className="bi bi-twitch" viewBox="0 0 16 16">
