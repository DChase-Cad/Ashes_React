                    ...
                    <div className="container container-fluid">
                        <div className="row justify-content-center">
                            <div className="col col-4 col-sm-3 col-md-2 align-self-center d-none d-sm-block">
                                <a href="index.html"><img src="../../public/assets/img/phoenix.png" alt="logo" className="img-fluid d-none d-md-block" /></a>
                            </div>
                            ...
                            <div className="col-4 col-sm-3 col-md-2 align-self-center d-none d-sm-block">
                                <a href="index.html"><img src={logo} alt="logo" className="img-fluid d-none d-md-block" /></a>
